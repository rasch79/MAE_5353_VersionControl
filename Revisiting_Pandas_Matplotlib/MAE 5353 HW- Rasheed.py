...
def create_performance_plot(source_file, plot_fname, dpi=300):
    ...
    steady_state_df = pd.read_excel(source_file, sheet_name= 'SteadyState', skiprows=0, header=2, names = column_names)
    
    uncertainty_df = pd.read_excel(source_file, sheet_name= 'OverallUncertainties', skiprows=0, header=2, names = column_names)
